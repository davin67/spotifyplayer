...
module WizardPageGenerator
  class PlatformAPIError < StandardError
  end

  HIJACK_INCLUDE_PATHS = {
    "components/platform_content.html" => "components/wizard/platform_content.html",
    "components/alert.html" => "components/wizard/alert.html"
  }

  # Override the tags to prevent them from converting markdown to html
