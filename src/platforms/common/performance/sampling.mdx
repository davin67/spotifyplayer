...
<!-- TODO: right now getting the parent sampling decision is broken in PHP -->
...
<!-- TODO: figure out if PHP can support returning a boolean -->
...
<!-- TODO: precedence is currently broken in PHP -->
