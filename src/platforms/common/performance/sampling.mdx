...
The information contained in the `samplingContext` object passed to the <PlatformIdentifier name="traces-sampler" /> when a transaction is created varies by platform.
